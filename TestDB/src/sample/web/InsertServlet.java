...
public class InsertServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			DataSource ds = (DataSource) initCtx.lookup("java:comp/env/dbtest");
	...
	private void insert(Connection connection) throws Exception {
		String sql = "INSERT INTO lecture.todo_list' ( 'title','task','limitdate','lastupdate','useri','status' " + ") VALUES ( ? , ? , ? , now() , ? , ? );";
